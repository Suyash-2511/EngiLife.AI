...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Updated to Violet (primary-600)
    primary: "bg-primary-600 text-white hover:bg-primary-700 shadow-lg shadow-primary-500/25 border border-transparent dark:shadow-primary-900/20",
